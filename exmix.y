...
%token EQUAL SIN COS TAN LOG SQRT SQR CUBE FACTORIAL POW PRINT PRINTLN MINIMUM MAXIMUM SWAP FUNCTION SORT
...
switch: /* empty */	
	...
	|CASE expression COLON expression END_LINE BREAK END_LINE switch	{c[$2]=$2;casea[$2]=$4; /*fprintf(yyout,"case %d\n",$2);*/}
...
expression: NUMBER {$$=$1;}
	...
	;
dgts:	NUMBER	{srtarr[$1]=$1;}
		|dgts COMMA NUMBER	{srtarr[$3]=$3;}
